...
Exemplos um pouco mais interessantes são os seguintes (lembrando que o símbolo de percentagem denota um comentário no código, enquanto que o subescrito denota uma variável anônima\marginpar{É uma variável a que não se dá nome. Assim, não se pode chamá-la depois: cada variável anônima é diferente.}):
