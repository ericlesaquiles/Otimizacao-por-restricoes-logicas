...
Exemplos um pouco mais interessantes são os seguintes (lembrando que o símbolo de percentagem denota um comentário no código, enquanto que o subescrito denota uma variável anônima\marginpar{É uma variável a que não se dá nome. Assim, não se pode chamá-la depois: cada variável anônima é diferente.}): %COMMENT: no capitulo 4 voce ja tinha explicado isso do _. Ou coloca um lembrando como eu coloquei, mas pode tirar a explicacao de que variaveis anonimas sao diferentes. Ou nem fala nada. Ja a porcentagem sendo um comentario, voce ja usou no capitulo 4, mas nao sei se explicou antes. Se nao explicou, eh melhor colocar essa explicacao na primeira vez que ele aparece. Ai aqui pode colocar um "lembrando" ou nao falar nada.
...
\lstinputlisting[caption= Mais]{../Exemplos/Cap6/prog3_mais.pl}
