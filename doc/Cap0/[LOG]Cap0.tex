...
``sua pergunta não faz sentido''.  Se foi um goal mal escrito (se ele ``não faz sentido''), pode gerar um erro (isto é, o goal gera um erro quando não é ``compreensível'' a
