...
\foreign{``Programmation Logique''}). Isso rende a vantagem de
...
A resposta à primeira pergunta é que o Prolog tem uma primitiva: o \definicao{funtor}. O termo \technical{funtor} foi introduzido por Rudolf Carnap, filósofo alemão do círculo de Viena, em seu \foreign{Logische Syntax der Sprache}\cite{carnap} e indica uma \enphasis{palavra função}
...
programação lógica), como em \enphasis{Teoria de Categoria}, com significado, em essência, semelhante.
