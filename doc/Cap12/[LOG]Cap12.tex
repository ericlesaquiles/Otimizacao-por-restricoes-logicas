...
``Oh, mas Theon! Devo ter me enganado ao achar que era um matemático, pois você me está parecendo
  ...
  contas, tempo esse que é, de fato, morto. %QUESTION: o tempo eh morto ou a pessoa morre de tanto tempo que demora?
...
%COMMENT: fica faltando colocar o modo como construiu as instancias e uma tabela com os resultados. Eu faria isso em uma secao separada, saindo desta "fabula" e explicando as coisas mais "tecnicas".

%COMMENT: acho que ficaria bom tambem destacar as diferencas dos 2 programas propostos para resolver o problema.
