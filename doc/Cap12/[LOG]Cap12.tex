...
inteira, o peso é escolhido estocásticamente como um valor entre 1 e
...
têm menos tipos de itens. A maneira escolhida foi de rodar $j$ vezes
...
$i \geq 6$\footnote{``No geral'', porque, os dados sendo aleatórios,
  ...
  caso geral.}. No lugar disso, então, foram rodados três testes
para esse, os dois primeiros como explicados anteriormente (no caso,
fazendo $i + 4 = 4$ e $i + 4 = 5$) e o terceiro caso de teste foi
feito com 50 itens, o qual foi rodado 6 vezes (sendo a quantidade de
...
disponível. Os pesos são como um número aleatório entre 1 e 50
(unidades de peso), os volumes são como um número aleatório entre 1
e 100 (unidades de volume) e as quantidades de itens como um número
aleatório entre 1 e 15.
