...
%COMMENT: antes de simplesmente passar para o grafo, acho que deveria colocar a restricao que ela representa e/ou explicar o que esse grafo quer dizer.
...
Esse grafo é uma outra forma de representar a restrição {\tt V=V1, V=V2, V1=I1 $\times$R1, V2=I2$\times$R2, I=I1+I2}\footnote{Exemplo adaptado de \cite{marriot}, pág. 36.}. Considere as restrições adicionais de que {\tt V=8, R1=6, R2=44}. Na propagação local, podemos considerar as arestas como veículos das restrições, deixando-as passar de nó em nó de forma apropriada, passo a passo. Por exemplo, dadas as restrições acima, a restrição de V=8 pode ser propagada para V1=8, e teríamos:
...
%COMMENT: Acho que precisa explicar melhor essa parte da propagacao. Talvez se melhorar a explicacao do que quer dizer o primeiro grafo ja seja suficiente.
...
%COMMENT: acho que o texto todo vai ficar mais bonito se aquelas anotacoes nas margens ficaram com a letra um pouco menor - agora eles estao com um espacamentos grandes.
