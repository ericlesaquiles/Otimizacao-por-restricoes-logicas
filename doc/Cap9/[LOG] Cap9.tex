...
demonstrativos: para algoritmos mais eficientes veja \cite{tsang}. O functor {\tt apply/2} é o definido no Capítulo 6.
...
Isso está sujeito ao potencial inconveniente de que restrições equivalentes mas escritas de formas diferentes podem oferecer
