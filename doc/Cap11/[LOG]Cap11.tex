...
restrições\footnote{Por conveniência, usamos $X_i$ no lugar de $X[i]$.} \codigo{$X_i$ - $X_j$ $\setminus=\setminus$ I - J} e \codigo{$X_i$ - $X_j$
...
mas, adotando um tempo limite de 50 segundos, \var{N} = 30 já está fora de mão (leva mais de 50
segundos).
