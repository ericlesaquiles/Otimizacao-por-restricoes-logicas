...
Analisaremos o efeito de algumas dessas heurísticas pela resolução do \enphasis{problema das
...
\begin{figure}[h]
  \caption{Retirado de \cite{krzysztof}}\label{fig:heur}
  \centering
...
\begin{figure}[h]
  \caption{Retirado de \cite{krzysztof}}\label{fig:rotate}
  \centering
