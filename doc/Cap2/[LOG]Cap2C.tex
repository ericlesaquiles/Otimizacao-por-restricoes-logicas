...
\caption{Natural}\label{lst:natural}
    ...
    \noindent então U(P) é o conjunto formado por 0, \funtor{natural/1} e suas combinações:
\[
...
\begin{definition} Dada uma interpretação I de um programa lógico, I é um modelo\definicao{Modelo} se, para cada cláusula de P, \codigo{a :- $b_0$, ..., $b_n$}, $a \in I$ se $b_0$, ..., $b_n$ $\in I$.
\end{definition}
