...
\begin{itemize}
\item Fazer uma análise de uma parte específica (como o da asa, ou do
  motor) do projeto, o que possibilitaria a quem cuidar dele fazer
...
satisfeita sem esforços mas, quando esse não é o caso, é preciso se
...
mais eficientemente do que um método de programação não linear
genérico).
...
problema será feita com base no pacote GPkit. % TODO ADD citation
...
de modo que podemos lidar com ele como um problema de programação
geométrica.

Resolvendo o problema, obtemos um custo ótimo de 303,1 e os seguintes
