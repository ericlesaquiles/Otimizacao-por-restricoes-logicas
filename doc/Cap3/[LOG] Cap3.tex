...
Voltando ao código \ref{lst:length}. %COMMENT: como na legenda dos programas fica escrito "codigo", acho que fica melhor ou chamar aqui de "codigo" em vez de "programa", ou chamar de "programa Append (Código 1)". Este vale para todas as referencias a programas.
